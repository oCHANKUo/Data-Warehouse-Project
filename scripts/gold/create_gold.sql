...
IF OBJECT_ID('gold.FactSalesOrderDetail', 'U') IS NOT NULL
    DROP TABLE gold.FactSalesOrderDetail;
...
IF OBJECT_ID('gold.DimSalesPerson', 'U') IS NOT NULL
...
IF OBJECT_ID('gold.DimTerritory', 'U') IS NOT NULL
