/*
===============================================================
    Script Name  : create_bronze_dimdate.sql
    Purpose      : Create and populate the DimDate table in the bronze schema.
    Description  :
        - Drops the DimDate table (dimension table)  if it exists.
        - Creates the [bronze].[DimDate] table for date dimension handling.
		- Later will be added to the Gold Layer
===============================================================
*/
